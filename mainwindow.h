...
private:
    ...
    /*check configuration*/
    QCheckBox * checkConfigurationCB;
    QCheckBox * convertConfCB;
    ...
    int checkConfigurationState;
    int convertConfigurationState;
...
private slots:
    ...
    void onCheckConfStateChanged(int state);
    void onConvertConfStateChanged(int state);
protected:
